...
(function($, Coral) {
    ...
    registry.register("foundation.validation.validator", {
        selector: "[data-validation=firstdemo-multifield]",
        validate: function(element) {
            ...
            if(items>max){
              ...
              return "You can add maximum "+max+" books. You are trying to add "+items+"to book."
            }
            if(items<min){
     ...
     registry.register("foundation.validation.validator", {
        selector: "[data-validation=firstdemo-firstname-validation]",
        validate: function(element) {
            let el = $(element);
            let pattern=/[0-9a-z]/;
            let value=el.val();
